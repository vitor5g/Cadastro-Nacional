...
//    console.log(data.getElementsByTagName('td')[7].innerHTML
    ...
    $(".cep")[0].value = data.getElementsByTagName('td')[5].innerHTML;
    $(".telefone")[0].value = data.getElementsByTagName('td')[6].innerHTML;

    console.log(data.getElementsByTagName('td')[5]);
